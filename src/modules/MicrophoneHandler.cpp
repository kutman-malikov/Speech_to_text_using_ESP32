...
void MicrophoneHandler::begin() {
    ...
    i2s_config_t i2s_config = {
        ...
        .channel_format = I2S_CHANNEL_FMT_ONLY_RIGHT, // ✅ ПРАВЫЙ КАНАЛ
        .communication_format = I2S_COMM_FORMAT_I2S_MSB, // старый формат, но стабильно работает
    ...
    Serial.println("[Mic] I2S initialized (RIGHT channel)");
}
...
void MicrophoneHandler::readAudio() {
    ...
    for (int i = 0; i < samplesRead; i++) {
        int32_t s = samples[i] >> 8; // 24-бит → 32-бит
        sum += abs(s);
    }
